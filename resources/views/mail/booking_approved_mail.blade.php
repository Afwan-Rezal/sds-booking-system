<h2>Your room booking, {{ $mailData['room'] }} has been approved!</h2>

<p>Hello, {{ $mailData['name'] }}!</p>
<p>We are pleased to inform you that your booking for the room <strong>{{ $mailData['room'] }}</strong> has been approved.</p>
